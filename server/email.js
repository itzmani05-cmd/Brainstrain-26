...
export function sendApprovalEmail(reg) {
  return send({
    ...
    html: `
      ...
      <p>You can share your referral code with multiple people — there's no limit! If someone registers using your referral code, ₹10 will be credited to your account one day before the event. 💰</p>
