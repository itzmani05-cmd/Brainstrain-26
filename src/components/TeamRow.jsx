export default function TeamRow({ title, members }) {
  return (
    <div className="mb-14 w-full items-center flex flex-col gap-2 sm:*: text-center">
      ...
      <div className="mx-auto flex w-full max-w-3xl flex-wrap justify-center gap-4 sm:gap-6 4xl:max-w-5xl 4xl:gap-10 6xl:max-w-6xl 6xl:gap-14 7xl:max-w-7xl 7xl:gap-16">
        {members.map((m, i) => (
          <div
            key={i}
